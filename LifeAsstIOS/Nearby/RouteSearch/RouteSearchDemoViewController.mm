...
//	_endAddrText.text = @"百度大厦";
    ...
    NSDictionary *locationDict = [[NSUserDefaults standardUserDefaults] objectForKey:LAUserLocationInfo];
    if (locationDict != nil) {
        _startCityText.text = locationDict[@"City"];
        _startAddrText.text = locationDict[@"Name"];
        _endCityText.text = locationDict[@"City"];
        _endAddrText.text = locationDict[@"翰林邻里中心"];
    }
